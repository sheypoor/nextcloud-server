...
<?php } else { ?>
	...
	<div id="public-upload">
		<div
			...
			<div id="drop-upload-progress-indicator" style="padding-block-start: 25px;" class="hidden"><span class="icon-loading-small"></span><?php p($l->t('Uploading files')) ?></div>
			<div id="drop-upload-done-indicator" style="padding-block-start: 25px;" class="hidden"><?php p($l->t('Uploaded files:')) ?></div>
